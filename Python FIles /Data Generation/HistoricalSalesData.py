...
#generate the series of dates between 2016 and 2026 

random_dates = np.random.choice(np.arange(np.datetime64('2016-01-01'),np.datetime64('2026-03-08')),size = num_rows)
...
df.to_csv('../../Data/FactOrdersData.csv',index=False)
